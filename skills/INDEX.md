...
| `repo-engine` | 0.1.0 | hybrid | Map repository architecture, entry points, conventions, hotspots, and onboarding artifacts for fast execution. |
| `spec-engine` | 0.1.0 | hybrid | Turn requests into structured, version-aware specs with clear requirements, acceptance criteria, and policy gates. |
| `test-engine` | 0.1.0 | rule | Design resilient test strategies and practical unit, integration, E2E, and Playwright coverage improvements. |
| `thinking-engine` | 0.1.0 | hybrid | Explore ambiguous problems, test assumptions, compare options, and produce decision-ready plans. |